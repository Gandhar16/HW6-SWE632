...
// function createStarRating(productKey) {
//   const container = document.querySelector('.review-star-rating[data-product="' + productKey + '"]');
//   container.innerHTML = ''; // Clear existing stars
//   for (let i = 1; i <= 5; i++) {
//       const star = document.createElement('span');
//       star.textContent = '★';
//       star.className = 'star';
//       star.onclick = function() { setRating(productKey, i); }; // Set rating on click
//       container.appendChild(star);
//   }
// }

// function setRating(productKey, rating) {
//   const stars = document.querySelectorAll('.review-star-rating[data-product="' + productKey + '"] .star');
//   stars.forEach((star, index) => {
//       star.style.color = index < rating ? 'gold' : 'gray';
//   });
//   // Store the rating
//   document.querySelector('.review-star-rating[data-product="' + productKey + '"]').dataset.rating = rating;
// }

function submitReview(productKey) {
  // Get the review text from the textarea
  const reviewText = document.querySelector('textarea[data-review-for="' + productKey + '"]').value.trim();
  ...
  if (reviewText) {
      ...
      document.querySelector('textarea[data-review-for="' + productKey + '"]').value = '';
  } else {
      alert('Please write a review before submitting.');
  }
}

// // Initialize star ratings for each product
// document.addEventListener('DOMContentLoaded', function() {
//   createStarRating('appleWatch7');
//   createStarRating('appleWatch8');
//   createStarRating('AsusTuf');
//   createStarRating('acerPredator');
//   createStarRating('iphone14');
//   createStarRating('samsungUltra');
//   createStarRating('hoodie1');
//   createStarRating('samsungUltra');
